...
public class Model implements Serializable{
	...
	public void addTimberHouse(String name, int squareFootage, int cost, ArrayList<String> roomList,
			String timberType) {
		
		ArrayList<Room> rooms = getRoomsFromList(roomList);
		Timber timber = new Timber(name, squareFootage, cost, rooms, timberType);
		houses.add(timber);
	}

	public void addMasonryHouse(String name, int squareFootage, int cost, ArrayList<String> roomList,
			int maxFloors) {
		
		ArrayList<Room> rooms = getRoomsFromList(roomList);
		Masonry masonry = new Masonry(name, squareFootage, cost, rooms, maxFloors);
		houses.add(masonry);
	}
